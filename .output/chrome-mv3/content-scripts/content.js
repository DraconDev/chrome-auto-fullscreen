  ...
  const definition = defineContentScript({
    ...
    async main() {
      ...
      const onVideoPlay = async (video) => {
        ...
        if (resp == null ? void 0 : resp.ctrlHeld) return;
        browser$1.runtime.sendMessage({ action: "sendFKey" });
      };
      const attachPlayListener = (video) => {

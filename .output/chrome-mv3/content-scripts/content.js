...
`);
  ...
  const definition = defineContentScript({
    ...
    async main() {
      ...
      let shouldAutoFullscreenOnLoad = isEnabled && autoFullscreenEnabled && !newTabIntent;

...
`);
  ...
  const definition = defineContentScript({
    ...
    async main() {
      ...
      const shouldAutoFullscreenOnLoad = isEnabled && autoFullscreenEnabled && !newTabIntent;

...
`);
  ...
  const definition = defineContentScript({
    ...
    async main() {
      ...
      let needsInitialFullscreen = isEnabled && autoFullscreenEnabled && !newTabIntent;

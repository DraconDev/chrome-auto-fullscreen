      ...
      document.addEventListener(
        ...
        (e) => {
          ...
          setTimeout(() => {
            ...
            const srcChanged = lastFullscreenedSrc !== "" && src !== lastFullscreenedSrc;

  ...
  const definition = defineContentScript({
    ...
    `;
      ...
      const toggleVideoFullscreen = (video) => {
        ...
        if (isOdysee) {
          const player = video.closest(".vjs-has-started");
          if (player) {

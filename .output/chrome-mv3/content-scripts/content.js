        ...
        (e) => {
          ...
          if (longPressDelay === 0) {
            ...
            if (video && !document.fullscreenElement) {
              ...
              video.requestFullscreen().then(() => log("requestFullscreen SUCCESS")).catch((err) => {
            ...
            chargeTimer = setTimeout(() => {
              ...
              const video = findVideo();
              if (video && !document.fullscreenElement) {
                video.requestFullscreen().then(() => log("charge requestFullscreen SUCCESS")).catch(() => {

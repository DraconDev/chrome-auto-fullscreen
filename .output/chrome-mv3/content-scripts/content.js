    ...
    async main() {
      ...
      const clickSiteFullscreenButton = () => {
        const btn = document.querySelector(
          `.ytp-fullscreen-button, .vjs-fullscreen-control, [aria-label*="ullscreen"], [title*="ullscreen"], .fullscreen-button, [data-purpose='fullscreen-button']`
        );
        if (btn) btn.click();
      };

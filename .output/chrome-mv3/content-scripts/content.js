    ...
    async main() {
      ...
      document.addEventListener(
        ...
        (e) => {
          ...
          const clickedVideo = clickTarget instanceof HTMLVideoElement ? clickTarget : null;
      ...
      document.addEventListener(
        ...
        (e) => {
          ...
          setTimeout(() => {
            ...
            const srcChanged = src !== ((lastFullscreenedVideo == null ? void 0 : lastFullscreenedVideo.currentSrc) || (lastFullscreenedVideo == null ? void 0 : lastFullscreenedVideo.src) || "");

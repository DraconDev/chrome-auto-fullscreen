...
`);
  ...
  const definition = defineContentScript({
    ...
    async main() {
      ...
      (await store.getValue()).strictSafety;
      ...
      document.addEventListener(
        ...
        (e) => {
          ...
          if (!isEnabled) {
            log("blocked: isEnabled=false");
            return;
          }
          if (e.button !== 0) {
            log("blocked: not left click, button=", e.button);
            return;
          }
          ...
          if (!clickedVideo) {
            log(
              "blocked: no video found. target=",
              (_a2 = e.target) == null ? void 0 : _a2.constructor.name,
              "tag=",
              (_b2 = e.target) == null ? void 0 : _b2.tagName
            );
            return;
          }
          ...
          log(
            "video found! size=",
            clickedVideo.offsetWidth,
            "x",
            clickedVideo.offsetHeight,
            "delay=",
            longPressDelay,
            "fullscreen=",
          ...
          if (longPressDelay === 0) {
            ...
            if (!document.fullscreenElement && clickedVideo.requestFullscreen) {
              clickedVideo.requestFullscreen().then(() => log("requestFullscreen SUCCESS")).catch((err) => log("requestFullscreen FAILED:", err));
            }
          } else {
